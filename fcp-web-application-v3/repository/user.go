...
func (r *userRepository) GetUserByEmail(email string) (model.User, error) {
	obtainUserbyEmail, err := r.filebasedDb.GetUserByEmail(email)
	if err != nil {
		return model.User{}, err
	}
	return obtainUserbyEmail, nil
}
...
func (r *userRepository) GetUserTaskCategory() ([]model.UserTaskCategory, error) {
	obtainUserTaskCategory, err := r.filebasedDb.GetUserTaskCategory()
	if err != nil {
		return nil, err
	}
	return obtainUserTaskCategory, nil
}
